import{_ as s,o as n,c as a,N as l}from"./chunks/framework.610c50cb.js";const u=JSON.parse('{"title":"event的用法——如何获取当前兄弟元素，子元素，父元素","description":"","frontmatter":{},"headers":[],"relativePath":"guide/js/event.md","lastUpdated":1718938826000}'),p={name:"guide/js/event.md"},e=l(`<h1 id="event的用法——如何获取当前兄弟元素-子元素-父元素" tabindex="-1">event的用法——如何获取当前兄弟元素，子元素，父元素 <a class="header-anchor" href="#event的用法——如何获取当前兄弟元素-子元素-父元素" aria-label="Permalink to &quot;event的用法——如何获取当前兄弟元素，子元素，父元素&quot;">​</a></h1><h2 id="vue中使用" tabindex="-1">vue中使用 <a class="header-anchor" href="#vue中使用" aria-label="Permalink to &quot;vue中使用&quot;">​</a></h2><div class="language-javascript line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">&lt;</span><span style="color:#F07178;">template</span><span style="color:#89DDFF;">&gt;</span></span>
